...
#define WELCOME_MSG                         _UxGT(" ") MACHINE_NAME _UxGT(" pripravena")
#define MSG_BACK                            _UxGT("Zpet")
#define MSG_SD_INSERTED                     _UxGT("SDcko vlozeno")
#define MSG_SD_REMOVED                      _UxGT("SDcko vyjmuto")
...
#define MSG_Z_FADE_HEIGHT                   _UxGT("Zmizet po vysce")
...
#define MSG_PREHEAT_1_SETTINGS              MSG_PREHEAT_1 _UxGT(" nastav")
...
#define MSG_PREHEAT_2_SETTINGS              MSG_PREHEAT_2 _UxGT(" nastav")
#define MSG_COOLDOWN                        _UxGT("Ochladit")
...
#define MSG_RETRACT                         _UxGT("Zatahnout (retr.)")
...
#define MSG_MOVING                          _UxGT("Presunuji...")
...
#define MSG_FAN_SPEED                       _UxGT("Rychlost vetr.")
#define MSG_EXTRA_FAN_SPEED                 _UxGT("Rychlost vetr.2")
#define MSG_FLOW                            _UxGT("Prutok")
#define MSG_CONTROL                         _UxGT("Nastaveni")
...
#define MSG_INIT_EEPROM                     _UxGT("Format EEPROM")
#define MSG_REFRESH                         _UxGT("Obnovit")
#define MSG_WATCH                           _UxGT("Domovska stranka")
#define MSG_PREPARE                         _UxGT("Prime rizeni")
...
#define MSG_INIT_SDCARD                     _UxGT("Format SD karty")
...
#define MSG_THERMAL_RUNAWAY                 _UxGT("RUNAWAY HOTEND")
#define MSG_THERMAL_RUNAWAY_BED             _UxGT("RUNAWAY HOTBED")
